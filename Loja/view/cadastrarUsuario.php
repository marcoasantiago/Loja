			...
			<td>
				...
				<table>
					<tr>
						...
						<td colspan="3" rowspan="1">Seja Bem-Vindo!Cadastrar Novo Usuário</td>
					...
					<tr>
						...
						<td><input type="text" name="txtendereco" value="<?PHP print $dados[12]; ?>" maxlength="80" title="Endereço" id="txtendereco" /></td>
					...
					<tr>
						<td>Número<em>*</em></td>
						<td><input type="text" name="txtnumero" value="<?PHP print $dados[13]; ?>" maxlength="11" title="Número" id="txtnumero" /></td>
							...
							<select id="txtestado" name="txtestado" title="Estado">
                            	<?php  
                                    ...
                                    while ( $reg = mysql_fetch_array($rs)) { ?>
                                    	...
                                    	<option id="ïdEstado" <?php if ($reg["NM_ESTADO"] == $dados[18]) { ?> selected="selected" <?php } ?>  value="<?php print $reg["ID_ESTADO"]; ?>" ><?php print $reg["NM_ESTADO"]; ?></option>
